...
public class EditarUsuario {
	...
	@Test
	public void preencherCampoEditarUsuario() {
		page.setSearchName("João Santos");
		page.aguardeCustomerName();
		Assert.assertEquals("João Santos", page.obterCustomerNamePesquisado());
		page.clickEdit();
		page.setSearchName(" Silva");
		page.setSave();
		page.mensagemSucessoUpdate();
		//Assert.assertEquals("Your data has been successfully updated. Go back to list", page.obterMensagemSuccessfullyUpdated());
	}
}
